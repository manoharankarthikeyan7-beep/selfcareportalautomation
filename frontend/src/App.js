...
const PipelineWizard = () => {
    ...
    const styles = {
        ...
        repoListWrapper: {
            ...
            width: "100%", // Ensures it stretches to the card width
            backgroundColor: "#fff"
        },
        repoItem: { 
            display: "flex",
            alignItems: "center",
            width: "100%", // Forces individual items to take full width
            padding: "14px 18px", 
            textAlign: "left", 
            cursor: "pointer", 
            border: "none", 
            ...
            fontSize: "14px",
            color: "#323130",
            boxSizing: "border-box", // Important for full-width padding
    ...
    const handleAction = async (shouldRun) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setStatus("❌ Action Failed. Check console for details.");
            }
        } catch (err) { 
            ...
            {step === 3 && (
                <div>
                    ...
                    <div style={{ marginTop: "20px" }}>
                        ...
                        <input style={styles.input} value={formData.name} placeholder="Pipeline Name" onChange={(e) => setFormData({...formData, name: e.target.value})} />
                    </div>
    ...
    <div style={{ padding: "40px", fontFamily: "Segoe UI", maxWidth: "900px", margin: "auto" }}>
      ...
      <UnauthenticatedTemplate>
        <div style={{ textAlign: "center", marginTop: "50px" }}>
          <button onClick={() => instance.loginRedirect(loginRequest)} style={{ padding: "12px 24px", background: "#0078d4", color: "white", border: "none", borderRadius: "4px", cursor: "pointer", fontWeight: "600" }}>Login</button>
        </div>
      </UnauthenticatedTemplate>
